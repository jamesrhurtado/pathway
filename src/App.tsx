...
import { ArrowUpRight, BookOpen, Bot, CalendarDays, Check, ChevronDown, CircleAlert, Clock3, DollarSign, ExternalLink, GitCompareArrows, Languages, LockKeyhole, Map, RefreshCcw, Search, ShieldCheck, Sparkles, Target, X } from 'lucide-react'
    ...
    <main id="main">
      ...
      {!roadmap && !state.discovery ? <section className="builder-view" aria-labelledby="page-title">
        <div className="intro-copy">
          ...
          <div className="agent-note"><Bot size={18} /><div><strong>Your agent can search and update this page.</strong><span>You review and approve the final path.</span></div></div>
        </div>

        <form className="goal-form" onSubmit={submitGoal}>
          <div className="form-heading"><h2>What do you want to learn?</h2><span className="step-label">Search first</span></div>
          ...
          <details className="goal-advanced">
            <summary><span>Add limits and preferences</span><small>Optional</small></summary>
          ...
          <div className="form-support"><button className="sample-link" type="button" onClick={loadJudgeExample}>Try a sample brief</button><p className="form-footnote"><ShieldCheck size={15} /> Curated resources are shown after you search.</p></div>
        </form>
